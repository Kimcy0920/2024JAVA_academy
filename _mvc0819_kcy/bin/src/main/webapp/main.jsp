...
<body>
	...
	<figure>
		...
		<div class="inner">
			<h1>Welcome</h1>
			<p>
				떡잎 마을에 오신걸 환영합니다. <br> 자유롭게 이용해 주세요.
			</p>
		</div>
	</figure>
		...
		<div class="inner">
			...
			<div class="wrap">
				<article>
					...
					<h2>
						<a
							href="https://namu.wiki/w/%EB%85%B8%ED%95%98%EB%9D%BC%20%EC%8B%A0%EB%85%B8%EC%8A%A4%EC%BC%80"
							target="_blank">신짱구</a>
					</h2>
					<p>크레용 신짱(짱구는 못말려)의 주인공. 노하라 히로시(신영식/신형만), 노하라 미사에(봉미선) 부부의
						아들이며, 노하라 히마와리(신짱아)의 오빠이다.</p>
				</article>
				...
				<article>
					...
					<h2>
						<a
							href="https://namu.wiki/w/%EB%85%B8%ED%95%98%EB%9D%BC%20%ED%9E%88%EB%A7%88%EC%99%80%EB%A6%AC"
							target="_blank">신짱아</a>
					</h2>
					<p>크레용 신짱의 등장인물. 노하라 히로시(신영식/신형만) & 노하라 미사에(봉미선) 부부의 사랑스런 딸이자,
						노하라 신노스케(신짱구)의 하나 뿐인 여동생이다.</p>
				</article>
				...
				<article>
					...
					<h2>
						<a
							href="https://namu.wiki/w/%EB%85%B8%ED%95%98%EB%9D%BC%20%ED%9E%88%EB%A1%9C%EC%8B%9C"
							target="_blank">신형만</a>
					</h2>
					<p>크레용 신짱(짱구는 못말려)의 주요 인물. 노하라 미사에(봉미선)의 남편이자 노하라 신노스케(신짱구)와
						노하라 히마와리(신짱아) 남매의 아버지다.</p>
				</article>
				...
				<article>
					...
					<h2>
						<a
							href="https://namu.wiki/w/%EB%85%B8%ED%95%98%EB%9D%BC%20%EB%AF%B8%EC%82%AC%EC%97%90"
							target="_blank">봉미선</a>
					</h2>
					<p>크레용 신짱(짱구는 못말려)의 주요 인물. 노하라 히로시(신영식/신형만)의 아내이자, 노하라
						신노스케(신짱구)와 노하라 히마와리(신짱아) 남매의 어머니다.</p>
				</article>
			</div>
		</div>
	</section>
